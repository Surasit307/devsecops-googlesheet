...
public class WriteToSheet {
    private static final String APPLICATION_NAME = "project-480253286080";
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        final String spreadsheetId = "1rq-MWvHteAHFK6Nk4DR5WIc9lNI10BCULyvj8avYyVM";
